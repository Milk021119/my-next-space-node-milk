  ...
  return (
    <div className="min-h-screen bg-[#f0f2f5] font-sans flex">
      ...
      <main className="flex-1 lg:ml-80 p-10">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 max-w-2xl space-y-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-slate-700">邮箱绑定</p>
              ...
              <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl opacity-60">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-bold text-slate-700">手机号</p>
                    <p className="text-xs text-slate-400">暂不支持</p>
                  </div>
                </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <input 
                ...
                className="flex-1 bg-slate-50 border border-slate-200 rounded-xl px-4 text-sm outline-none focus:border-purple-500"
              />
              <button 
                onClick={handleUpdatePassword}
                disabled={loading || !newPassword}
                className="bg-slate-900 text-white px-6 py-3 rounded-xl text-sm font-bold hover:bg-purple-600 transition-colors"
              >
                {loading ? '保存中...' : '修改密码'}
              </button>
            </div>
