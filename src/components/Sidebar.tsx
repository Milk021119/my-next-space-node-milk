...
import { 
  Home, Archive, User, LogIn, LogOut, 
  Github, Ghost, Camera, Menu, X 
} from 'lucide-react'; 
...
export default function Sidebar() {
  ...
  const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false); // ✨ 内部管理状态
    ...
    <>
      ...
      `}>
        ...
        <div className="relative group w-24 h-24 mb-10 mx-auto lg:mx-0">
          ...
          <input type="file" id="avatar-input" className="hidden" accept="image/*" onChange={async (e) => { /* 逻辑略 */ }} />
        </div>
